...
sidebar_position: 6
slug: /connectionwrapper/executingqueries
...
:::info Important
*Cursor keeps connection open till `cursor.close()` method is called. When the Cursor is no longer needed, it must be closed.*
:::
