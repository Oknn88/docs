...
title: Cursor Class
sidebar_position: 3
slug: /connectionwrapper/cursorclass
...
This is a read only property that returns the [Connection](connectionclass) instance.
...
:::note
*It is not recommended enabling caching for large dataset. This may cause memory overhead.*
:::
`cursor.cached()`
...
This call closes cursor permanently and releases [Connection](connectionclass).
...
:::note
Cache must be enabled to move cursor back.
:::
`cursor.prev()`
