...
title: Pool Class
sidebar_position: 1
slug: /connectionwrapper/poolclass
...
:::note
Before initializing a connection pool, required dialect extension must be loaded.
:::
## Construction
...
### metaData
Retuns [MetaData](metadataclass) instance that helps working with database meta-data.
